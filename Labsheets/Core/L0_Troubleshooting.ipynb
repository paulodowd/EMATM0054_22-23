  ...
  "cells": [
    {
      ...
      "source": [
        ...
        "- I can't upload my code to the 3Pi+ / Romi, it won't connect.\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "\n",
        "The 3Pi+ and Romi can sometimes lose its ability to connect to your computer.  Follow these steps to fix it.  On rare occasions, this problem can keep re-occuring, but this method can be repeated quickly and easily.\n",
        "\n",
        "\n",
        "### Step1 \n",
        ...
        "    \n",
        "<img src=\"https://github.com/paulodowd/EMATM0053_21_22/blob/main/images/verbose_upload.png?raw=true\">\n",
        "\n",
        "### Step 3\n",
        "\n",
        "\n",
        ...
        "    \n",
        "<img src=\"https://github.com/paulodowd/EMATM0053_21_22/blob/main/images/reset_fade.gif?raw=true\" >\n",
        "\n",
        "\n",
        "### Step 5\n",
        "\n",
        ...
        "\n",
        "<img src=\"https://github.com/paulodowd/EMATM0053_21_22/blob/main/images/searching_for_port.png?raw=true\">\n",
        "\n",
        "### Step 7\n",
        "\n",
        ...
        "\n",
        "<img src=\"https://github.com/paulodowd/EMATM0053_21_22/blob/main/images/success.png?raw=true\">\n",
        "\n",
        "### Step 8\n",
        "\n",
